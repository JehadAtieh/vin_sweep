...
import 'package:vin_sweep/Landing/Screen_Landing/second_landing.dart';
        ...
        return Column(
          ...
          children: [
              ...
              child: Center(
                child: Transform.scale(
                  ...
                  child: Lottie.network(
                    landingController.landingPages[index].imageUrl,
                  ),
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Center(
                  child: Text(
                landingController.landingPages[0].title,
                style: const TextStyle(
                  fontFamily: 'OpenSans',
            ...
            Center(
              ...
              child: Text(
                landingController.landingPages[0].description,
                style: const TextStyle(
                  color: Color(0xFF919191),
                  fontFamily: 'OpenSans',
            ...
            Align(
              ...
              child: Padding(
                ...
                child: SmoothPageIndicator(
                    controller: landingController.pageControllerIndicator,
                    // PageController
                    count: 3,
