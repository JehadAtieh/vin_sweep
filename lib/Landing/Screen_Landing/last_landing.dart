...
class LastLanding extends StatefulWidget {
  const LastLanding({super.key});

  @override
  State<LastLanding> createState() => _LastLandingState();
}

class _LastLandingState extends State<LastLanding> {
  LandingPageController landingController = Get.put(LandingPageController());
  PageController pageControllerIndicator = PageController(initialPage: 2);
        ...
        return Column(
          ...
          children: [
              ...
              child: Center(
                child: Transform.scale(
                  ...
                  child: Lottie.network(
                    landingController.landingPages[2].imageUrl,
                  ),
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Center(
                  child: Text(
                    landingController.landingPages[2].title,
                    style: const TextStyle(
                      fontFamily: 'OpenSans',
            ...
            Center(
                child: Padding(
                  ...
                  child: Text(
                    landingController.landingPages[2].description,
                    style: const TextStyle(
                      color: Color(0xFF919191),
                      fontFamily: 'OpenSans',
